document.addEventListener("DOMContentLoaded", () => {
  ...
  function hideAllSections() {
    ...
    buttons.forEach((button) => {
      button.style.backgroundColor = "purple"; // Reset to purple
  ...
  function styleButton(button) {
    button.style.backgroundColor = "purple"; // Purple background
  ...
  function createButton(button, label, section) {
    ...
    button.addEventListener("click", () => {
      ...
      button.style.color = "purple"; // Highlighted font color
      button.style.border = "2px solid purple"; // Highlighted border
    });
